...
\label{ch:background}
\noindent
Here is for background.


\chapter[Related Work]{Related Work}
\label{ch:relatedwork}
\noindent
There have been extensive studies on cognitive radio in recent years.
...
\section{Quantum Communication}
 To enhance the performance gain of original cognitive radio networks (CRNs), leveraging cooperative diversity has attracted a lot of attention \cite{SOCA1}...
