...
\title[korean] {올바른 WebAssembly 명세를 위한 실행가능한 알고리즘 명세 언어 정의}
\title[english]{Defining An Executable Algorithmic Specification Language for Correct WebAssembly Specification}
