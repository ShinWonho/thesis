...
% ReturnFunc
\returnfuni{} instruction evaluates $e$, results in \ret{} with the resulting
...
\newline \\
  wc = \getcurctx(w, s) \\
  \hline
  w, \mu \vdash \getcurctxe ~ s \Rightarrow wc \\
%
% CtxKind
\newline \\
...
\newline \\
  ...
  b &\quad\quad\premise{if}\quad v = \boolv ~ b \\
    \istrue(v_1) ~ \land ~ ... ~ \istrue(v_n) &\quad\quad\premise{if}\quad
    v = \listv ~ v_1 ~ ... ~ v_n \\
  \end{cases} \\
%
% is_frame
