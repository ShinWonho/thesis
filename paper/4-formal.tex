...
% continuation
A continuation is \mt{} for empty continuation; \call{} for a function call
with let binding; \wasm{} for executing a Wasm instruction in the Wasm
instruction
stack; \exe{} for executing $wi$; \algo{} for interpreting AL instructions; or
\ret{} for returning from a AL function.
A continuation is \mt{} for an empty continuation, \call{} for a function call
with let binding, \wasm{} for executing a Wasm instruction in the instruction
stack, \exe{} for executing a given Wasm instruction $wi$, \algo{} for
interpreting AL instructions, or \ret{} for returning from an AL function.
% env
