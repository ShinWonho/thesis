...
and a continuation; \wasm with contexts and a continuation; \exe with a
WebAssembly instruction and a continuation; \algo with AL instructions, an
environment, contexts, and a continuation; or \ret with a AL value and a
continuation.
% env
