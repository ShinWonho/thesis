...
%
% Algorithm
  a \in A =& ~ \rel ~ String \times \seq E \times \seq I \\
    | & ~ \fun ~ String \times \seq E \times \seq I \\
%
% Wasm state
...
%
% Store
  sto \in Store =& \seq{(String \times V)} \\
%
% Continuation
  k \in Cont =& ~ \mt \\
    | & ~ \toplevelcall ~ String \times \seq V \times Cont \\
    | & ~ \call ~ String \times String \times \seq V \times Cont \\
    | & ~ \wasm ~ \seq C \times Cont \\
    | & ~ \exe ~ WasmInstr \times Cont \\
