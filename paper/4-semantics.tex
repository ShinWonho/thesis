...
\newline \\
  \hline
  a, w, \al~ (\seq{i}, \mu, n, c) \vdash \returni \Rightarrow (w, c) \\
%
% Return-some
\newline \\
  w, \mu \vdash e \Rightarrow v \\
  \hline
  a, w, \al ~ (\seq{i}, \mu, n, c) \vdash \returni ~ e \Rightarrow (w, \ret ~ (v, c)) \\
%
% Execute
\newline \\
  \mu = \getenv(c) \quad
...
\newline \\
  ...
  \hline
  a, w, c \vdash \performi ~ (str, \seq e) \Rightarrow (w, \call ~ (str, \seq v, c)) \\
%
% Replace-frame
\newline \\
...
\newline \\
  ...
  \hline
  w, \mu \vdash \calle ~ (str, \seq{e}) \Rightarrow v' \\
%
% Call-normal
\newline \\
