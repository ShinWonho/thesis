...
structured execution and aid in handling nested or complex control flows.
...
The \texttt{br} and \texttt{return} instructions jumps to the beginning or
the end of the block and the function, specified within the contexts, providing
targeted control transfers.
